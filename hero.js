...
// Instead of commenting out the blocks of code that we dont want,
// we instead set 'move' equal to the one of the strategies that are
// defined in the 'moves' variable.
